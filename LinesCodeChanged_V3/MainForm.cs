namespace CountLinesCodeChanged_V3
{
    ...
    //        // Save JSON button
    //        btnSaveJson = new Button { Text = "Save JSON", Size = new Size(100, 40), Location = new Point(920, 275), BackColor = Color.LightBlue };
    //        btnSaveJson.Enabled = false;
    //        btnSaveJson.Click += BtnSaveJson_Click;

    //        // Save CSV button
    //        btnSaveCsv = new Button { Text = "Save CSV", Size = new Size(100, 40), Location = new Point(1030, 275), BackColor = Color.LightBlue };
